...
![Keyboard](https://raw.githubusercontent.com/ElmoDFGD/ElmoRim/main/media/ElmoRim130Keyboard.png)
![Mouse](https://raw.githubusercontent.com/ElmoDFGD/ElmoRim/main/media/ElmoRim140%20Mouse.png)
...
### Horses
[Simple Horse SE](https://www.nexusmods.com/skyrimspecialedition/mods/12650) gives the player the ability to summon their horse by whistling for it. Default: `V`. In ElmoRim horses have an inventory thanks to [Dynamic Activation Key - Addons Collection](https://www.nexusmods.com/skyrimspecialedition/mods/96430). Access the inventory with `LCtrl + E`.
...
- [Skyrim Unbound](https://www.nexusmods.com/skyrimspecialedition/mods/27962) is an alternate start mods that allows the player to choose starting gear, spells and location along with many other options.
...
2. Disable all mods **EXCEPT those under the Bethesda Content and Upscaled Textures separators**
