...
* Hotkeys 1-4 are dedicated to cycling weapons/spells/shields/items. 5-8 work the same way as in vanilla. Read more [below](#lamas-tiny-hud).

* By default, SkyUI equipsets are mapped to Num 1-4.

* Num 0 is used to toggle Run/Walk.
...
![Mouse](https://raw.githubusercontent.com/ElmoDFGD/ElmoRim/1.4.0/media/ElmoRim140%20Mouse.png)
  ...
  >
  >* Execute button is defined in the Valhalla Combat MCM
...
The combat in ElmoRim is a lot more fast paced than vanilla Skyrim. This means a new system for smoothly switching between sets of weapons/spells/powers on the fly is needed. [Lamas Tiny Hud](https://www.nexusmods.com/skyrimspecialedition/mods/82545) is compact, responsive and easy to configure.
 ...
 > Pro tip: Support spells such as Oakflesh are excellent candidates for the top slot. This frees up space in the Left/Right slots, allowing for a smoother experience when switching mid-combat.
...
* [NPC Stat Rescaler](https://www.nexusmods.com/skyrimspecialedition/mods/24254) ensures a high tempo by adjusting NPC health scaling to avoid damage sponges.
* [Elden Counter](https://www.nexusmods.com/skyrimspecialedition/mods/65579) Ads the ability to perform a counter attack after blocking a hit, akin to Elden Rings guard counter. Simply press the power attack button after a successful block.
...
- [College For Non-Mages](https://www.nexusmods.com/skyrim/mods/40430) tweaks the classroom scene in the quest [First Lessons](https://elderscrolls.fandom.com/wiki/First_Lessons), giving the players the option of progressing the questline without being forced to learn a ward spell.
> Be careful not to skip any dialogue as it could break the scene.
...
7. If the enemy's healthbar is flashing and a metallic sound plays, they can be executed. `Default key: MB3`
...
13. There are many ways to be a cannibal. [Worship Namira](https://www.nexusmods.com/skyrimspecialedition/mods/54099) to feed on corpses. [Wear their ring](https://www.nexusmods.com/skyrimspecialedition/mods/31612) to unlock the stacking effect of the blessing. Or do both for the ultimate feast.  

# Tweaking the game settings

## BethINI

To get some more FPS or better visuals, tweak the following values in BethINI.

- `Visuals>Grass Density`: Change to 60 for more FPS or 20 for more dense grass
...
> ElmoRim doesn't utilize borderless upscaling. As such the monitor's resolution must be set to match the chosen game resolution.

## Upscaling quality 
Upscaling quality can make a few frames of difference. *Balanced* is the default settings. It can be changed in-game through the Upscaler GUI. Default key: `End`.

- `Upscale type`: Set to performance for more FPS or quality for better resolution.
...
2. Disable all mods **EXCEPT unofficial performance optimized textures AKA (UPOT)**
...
* Xavbio's retextures when AIO is released
* ferrari's script fixes when AIO is released
* Simplify DAR setup
* Azurite weathers & Visibility lighting setup
* Switch Reliquary of Myth to Vestige
